  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="index.php"><b>LEARN</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign In</p>
        <form action="../controller/DBLogin.php" method="post">
    ...
    <footer>
        <p class="al"> 2017 &copy; An Intelligent Recommender System Based on Learners&apos; Skills</p>
