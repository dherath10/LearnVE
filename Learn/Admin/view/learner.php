...
include '../model/learnermodel.php';
$obj=new User();
...
$(document).ready(function() {
  ...
  <body class="hold-transition sidebar-mini">
          ...
          <div class="row">
            <div class="col-xs-12"><!-- /.box -->
                ...
                <div class="box-header">
                    <h3 class="al">Learner Management</h3>
                </div><!-- /.box-header -->
	...
	$ob=new Learn();
$result=$ob->viewLearner();

	
		
		while($rowusers=$result->fetch(PDO::FETCH_BOTH))
		{
                    if($rowusers['learn_image']==""){
                        $path="../dist/img/avatar5.png";
                    }else{
                        $path="../../images/learner_images/".$rowusers['learn_image'];
                    }
		if($rowusers['learn_status']=="Active"){
                    $status="Deactive";
                }else{
                    $status="Active";
                }
		?><tr <?php if(isset($_REQUEST['msg']) && $count==1){ ?>
           ...
           <?php } ?>>
                ...
                <td><?php echo $rowusers['learn_fname']; ?></td>
                <td><?php echo $rowusers['learn_lname']; ?></td>
                <td><?php echo $rowusers['learn_email']; ?></td>
                <td><?php echo $rowusers['reg_no']; ?></td>
                <td><?php echo $rowusers['learn_gender']; ?></td>
                <td><?php echo $rowusers['learn_status']; ?></td>
                <td>
